                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Receive updates about your attendance and classes</p>
                    </div>
                    <Badge variant="secondary">Coming Soon</Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get notified about low attendance warnings</p>
                    </div>
                    <Badge variant="secondary">Coming Soon</Badge>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Reminders about upcoming classes</p>
                    </div>
                    <Badge variant="secondary">Coming Soon</Badge>
                  </div>
                </div>
